...
my $name = 'fred';
Char::INFORMIXV6ALS::substr($name, 4) = 'dy';
if ($name eq 'freddy') {
...
my $null = Char::INFORMIXV6ALS::substr $name, 6, 2;
if ($null eq "") {
...
my $oops = Char::INFORMIXV6ALS::substr $name, 7;
if (not defined $oops) {
...
eval {
    Char::INFORMIXV6ALS::substr($name, 7) = 'gap';
};
if ($@) {
