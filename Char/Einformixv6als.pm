...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Char::Einformixv6als::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Chop string
  ...
  character chopped. The Char::Einformixv6als::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Einformixv6als::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Char::Einformixv6als::fc function for case-insensitive comparisons via Char::INFORMIXV6ALS
  software.
...
=item Fold case string
  ...
  New to Char::INFORMIXV6ALS software, this function returns the full Unicode-like casefold of
...
=item File test function Char::Einformixv6als::X
...
=item Filename expansion (globbing)
  ...
  The Char::Einformixv6als::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Char::Einformixv6als::stat, Char::Einformixv6als::lstat, or Char::Einformixv6als::stat-based file test function
