...
# regexp of character
BEGIN { CORE::eval q{ use vars qw($your_char) } } $your_char = q{\xFD[\xA1-\xFE][\xA1-\xFE]|[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[\x00-\xFF]};
...
sub Char::Einformixv6als::filetest {
    ...
    unless (CORE::eval qq{Char::Einformixv6als::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Einformixv6als::filetest_ {
    ...
    unless (CORE::eval qq{Char::Einformixv6als::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
sub Char::INFORMIXV6ALS::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::INFORMIXV6ALS::escape_token();
    }
...
#
sub Char::INFORMIXV6ALS::escape_token {
...
# subroutines of package Char::Einformixv6als
    ...
    elsif (/\G \b Char::INFORMIXV6ALS::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::INFORMIXV6ALS::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::INFORMIXV6ALS::escape'; }
...
# subroutines of package Char::Einformixv6als
        ...
        elsif ($string =~ /\G \b Char::INFORMIXV6ALS::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::INFORMIXV6ALS::eval \b                                /oxgc) { $e_string .= 'eval Char::INFORMIXV6ALS::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::INFORMIXV6ALS::re_t=%s; local $Char::INFORMIXV6ALS::re_a=''; while($Char::INFORMIXV6ALS::re_t =~ %s){%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s$Char::INFORMIXV6ALS::re_t="$Char::INFORMIXV6ALS::re_a${1}$Char::INFORMIXV6ALS::re_r$'"; pos($Char::INFORMIXV6ALS::re_t)=length "$Char::INFORMIXV6ALS::re_a${1}$Char::INFORMIXV6ALS::re_r"; $Char::INFORMIXV6ALS::re_a=substr($Char::INFORMIXV6ALS::re_t,0,pos($Char::INFORMIXV6ALS::re_t)); } return $Char::INFORMIXV6ALS::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::INFORMIXV6ALS::re_r=CORE::eval $Char::INFORMIXV6ALS::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::INFORMIXV6ALS::re_t=%s; while($Char::INFORMIXV6ALS::re_t =~ %s){%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s$Char::INFORMIXV6ALS::re_t="$`$Char::INFORMIXV6ALS::re_r$'"; pos($Char::INFORMIXV6ALS::re_t)=length "$`$Char::INFORMIXV6ALS::re_r"; } return $Char::INFORMIXV6ALS::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s"%s$Char::INFORMIXV6ALS::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::INFORMIXV6ALS::re_n=0; local $Char::INFORMIXV6ALS::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s%s="$Char::INFORMIXV6ALS::re_a${1}$Char::INFORMIXV6ALS::re_r$'"; pos(%s)=length "$Char::INFORMIXV6ALS::re_a${1}$Char::INFORMIXV6ALS::re_r"; $Char::INFORMIXV6ALS::re_a=substr(%s,0,pos(%s)); $Char::INFORMIXV6ALS::re_n++} return %s$Char::INFORMIXV6ALS::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::INFORMIXV6ALS::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s%s="$`$Char::INFORMIXV6ALS::re_r$'"; pos(%s)=length "$`$Char::INFORMIXV6ALS::re_r"; $Char::INFORMIXV6ALS::re_n++} return %s$Char::INFORMIXV6ALS::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s%s="%s$Char::INFORMIXV6ALS::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::INFORMIXV6ALS::re_r=%s; %s%s="%s$Char::INFORMIXV6ALS::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::INFORMIXV6ALS::re_r=CORE::eval $Char::INFORMIXV6ALS::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use Char::INFORMIXV6ALS software automatically, you
do not have to use.
