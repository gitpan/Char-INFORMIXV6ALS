...
This module is a run-time routines of the Char::INFORMIXV6ALS module.
Because the Char::INFORMIXV6ALS module automatically uses this module, you need not use directly.
...
=item current position of the readdir
  ...
  Char::Einformixv6als::telldir(DIRHANDLE);
