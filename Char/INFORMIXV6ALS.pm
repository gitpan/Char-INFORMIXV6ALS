...
BEGIN { require Char::Einformixv6als; }
...
written by INFORMIX V6 ALS.

Perl is optimized for problems which are about 90% working with text and about
10% everything else. But this "text" means US-ASCII text, and popular INFORMIX V6 ALS
...
Perl3 or later can treat INFORMIX V6 ALS.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::INFORMIXV6ALS software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw INFORMIX V6 ALS, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Einformixv6als.pm.
  ...
  ${Char::Einformixv6als::not_space}      qr{(?:\xFD[\xA1-\xFE][\xA1-\xFE]|[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFD\x09\x0A\x0B\x0C\x0D\x20])}
...
Contrasting is Encode module and describing "use Char::INFORMIXV6ALS;" on this software,
