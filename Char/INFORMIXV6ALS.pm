...
sub Char::INFORMIXV6ALS::escape_script {
    ...
    if (/^ use Char::Einformixv6als(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::INFORMIXV6ALS version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::INFORMIXV6ALS qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::INFORMIXV6ALS ver.sion qw(ord reverse);
  use Char::INFORMIXV6ALS ver.sion.0 qw(ord reverse);
