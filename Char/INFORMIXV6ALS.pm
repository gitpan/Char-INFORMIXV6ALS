...
######################################################################
#
# Char::INFORMIXV6ALS - Source code filter to INFORMIX V6 ALS script
#
...
sub Char::INFORMIXV6ALS::escape_script {
    ...
    if (/^ use Char::Einformixv6als(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Einformixv6als %s;\n%s", $Char::Einformixv6als::VERSION, $use_re_eval); # require run-time routines version
...
Char::INFORMIXV6ALS - Source code filter to escape INFORMIX V6 ALS

=head1 SYNOPSIS

  use Char::INFORMIXV6ALS;
  use Char::INFORMIXV6ALS version;         --- require version
...
better, fitter Char::INFORMIXV6ALS.
...
Regular expression works as character-oriented that has no /b modifier.
  ...
  m?regexp?               m?ditto@Char::Einformixv6als::matched?
  s/regexp/replacement/   ($_ =~ m/ditto@Char::Einformixv6als::matched/) ?
                          eval{ Char::Einformixv6als::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
...
Regular expression works as byte-oriented that has /b modifier.
  ...
  m?regexp?b              m?regexp@Char::Einformixv6als::matched?
  s/regexp/replacement/b  ($_ =~ m/(\G[\x00-\xFF]*?)(?:regexp)@Char::Einformixv6als::matched/) ?
                          eval{ Char::Einformixv6als::s_matched(); local $^W=0; my $__r=qq/replacement/; $_="${1}$__r$'"; 1 } :
                          undef
