...
=item Make character
  ...
  set. For example, Einformixv6als::chr(65) is "A" in either ASCII or INFORMIX V6 ALS, not Unicode,
  and Einformixv6als::chr(0x82a0) is a INFORMIX V6 ALS HIRAGANA LETTER A. For the reverse of
  Einformixv6als::chr, use INFORMIXV6ALS::ord.
