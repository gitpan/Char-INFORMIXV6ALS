...
# regexp of character
my $qq_char   = qr/\\c[\x40-\x5F]|\\?(?:\xFD[\xA1-\xFE][\xA1-\xFE]|[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[\x00-\xFF])/oxms;
my  $q_char   = qr/\xFD[\xA1-\xFE][\xA1-\xFE]|[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[\x00-\xFF]/oxms;
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (INFORMIXV6ALS software provides)

INFORMIXV6ALS software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (INFORMIXV6ALS software provide)
...
=head1 Escaping File Test Operators (INFORMIXV6ALS software provide)
