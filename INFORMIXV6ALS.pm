...
# subroutines of package Einformixv6als
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc)    { $slash = 'm//'; return "Einformixv6als::$1(" . e_q ('',  $2,$4,$3) . ")"; }
...
# subroutines of package Einformixv6als
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc)    { $e_string .= "Einformixv6als::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
